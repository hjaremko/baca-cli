...
impl<'a> Request<'a> {
    ...
    pub fn submit(&self, task: &Task, file_path: &str) -> crate::error::Result<Response> {
    ...
    fn make_submit_request(&self, task: &Task, file_path: &str) -> crate::error::Result<RequestBuilder> {
