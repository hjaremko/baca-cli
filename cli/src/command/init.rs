...
impl Init {
    fn get_host(&self) -> api::error::Result<String> {
    ...
    fn get_login(&self) -> api::error::Result<String> {
    ...
    fn get_password(&self) -> api::error::Result<String> {
...
impl Command for Init {
        ...
        A: BacaApi,
    {
        ...
        let mut config = workspace::ConnectionConfig {
            ...
            login,
            password,
            permutation: api::api::details::permutation(),
            cookie: "".to_string(),
        };

        let cleanup_directory = |e| match e {
            api::error::Error::WorkspaceAlreadyInitialized => e,
            _ => {
                workspace
                    .remove_workspace()
...
fn save_version<W: Workspace>(workspace: &W) -> api::error::Result<()> {
