...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        let msg = match self {
            ...
            Error::OpeningWorkspace(e) => format!("Error opening workspace directory: {}", e),
            Error::WritingWorkspace(e) => format!("Error writing config to the workspace directory: {}", e),
            Error::RemovingWorkspace(e) => format!("Error removing workspace directory: {}", e),
            Error::RemovingTask(e) => format!("Error removing task config: {}", e),
            Error::ReadingTask(e) => format!("Error reading task config: {}", e),
